        ...
        if serial.Serial.isOpen(obj.CtrlB):
            ...
            if flag == 'IDT':
                ...
                while c2 == '0000' or c2 == 'ffff':
                    ...
                    count += 1
                    if count == 5:
                        print('5 times not get drv1 value, please check')
                        break
                obj.CtrlB.write(b'fs400_drv_read 0x0409\n\r');
                time.sleep(0.2)
                s = obj.CtrlB.read_all().decode('utf-8').split(' ')
                ...
                while c3 == '0000' or c3 == 'ffff':
                    ...
                    count += 1
                    if count == 5:
                        print('5 times not get drv2 value, please check')
                        break
                # write in the drv information
                m = 'fs400_set_eep_drv_ver 0x0 0x{} 0x{} 0x{}\n\r'.format(c1, c2, c3).encode('utf-8')
                print('Driver information write:', m)
                obj.CtrlB.write(m);
                time.sleep(0.2)  # b'fs400_set_eep_drv_ver 0x0 0xe0cf 0x194a 0x4431\n'
                # TIA config
                obj.CtrlB.write(b'fs400_tia_read 0x0001\n\r');
                time.sleep(0.2)
                s = obj.CtrlB.read_all().decode('utf-8').split(' ')
                ...
                while a2 == '0000' or a2 == 'ffff':
                    ...
                    count += 1
                    if count == 5:
                        print('5 times not get tia1 value, please check')
                        break
                obj.CtrlB.write(b'fs400_tia_read 0x0009\n\r');
                time.sleep(0.2)
                s = obj.CtrlB.read_all().decode('utf-8').split(' ')
                ...
                while a3 == '0000' or a3 == 'ffff':
                    ...
                    count += 1
                    if count == 5:
                        print('5 times not get tia2 value, please check')
                        break
                # Drv config
                m1 = 'fs400_set_eep_tia_ver 0x0 0x{} 0x{} 0x{}\n\r'.format(a1, a2, a3).encode('utf-8')
                print('TIA information write:', m1)
                obj.CtrlB.write(m1);
                time.sleep(0.2)  # b'fs400_set_eep_tia_ver 0x0 0xe0cf 0x4014 0x4303\n'
            elif flag=='ALU':
                print('ALU device information write in')
                obj.CtrlB.write(b'fs400_set_eep_drv_ver 0x1 0x0 0x0 0x0\n\r');time.sleep(0.5)
                obj.CtrlB.write(b'fs400_set_eep_tia_ver 0x1 0x0 0x0 0x0\n\r');time.sleep(0.5)
            ...
            if flag=='IDT':
                ...
                s=obj.CtrlB.read_all().decode('utf-8').split(' ')
                b1=s[3][-2:]+s[4][-2:]
                #add judgement to ensure PKD read ok
                count=0
                while b1=='0000' or b1=='ffff':
                    obj.CtrlB.write(b'fs400_drv_read 0x0427\n\r');
                    time.sleep(0.5)
                    if not b'fs400_drv_read' in obj.CtrlB.read_all():
                        print(obj.CtrlB.read_all())
                    ...
                    count+=1
                    if count==5:
                        print('5 times not get pdk1 value, please check')
                        break
                obj.CtrlB.write(b'fs400_drv_read 0x0527\n\r');time.sleep(0.5)
                print(obj.CtrlB.read_all())
                obj.CtrlB.write(b'fs400_drv_read 0x0527\n\r');time.sleep(0.5)
                ...
                while b2=='0000' or b2=='ffff':
                    ...
                    count+=1
                    if count==5:
                        print('5 times not get pdk2 value, please check')
                        break
                obj.CtrlB.write(b'fs400_drv_read 0x0627\n\r');time.sleep(0.5)
                print(obj.CtrlB.read_all())
                obj.CtrlB.write(b'fs400_drv_read 0x0627\n\r');time.sleep(0.5)
                ...
                while b3=='0000' or b3=='ffff':
                    ...
                    count+=1
                    if count==5:
                        print('5 times not get pdk3 value, please check')
                        break
                obj.CtrlB.write(b'fs400_drv_read 0x0727\n\r');time.sleep(0.5)
                print(obj.CtrlB.read_all())
                obj.CtrlB.write(b'fs400_drv_read 0x0727\n\r');time.sleep(0.5)
                ...
                while b4=='0000' or b4=='ffff':
                    ...
                    count+=1
                    if count==5:
                        print('5 times not get pdk4 value, please check')
                        break
...
def write_eeprom_finalKT58(obj,sn,df,flag='IDT',Drv3='0x12fc',tempe=4310,VOA_cal=25):
    '''
    Write the test data into the eeprom with all the pages:0-5,7,8,9,11-16
    Update on 20220908:Write all the pages including all VOA calibration data, and add read and check,
    Attention:Always write all we need before save, otherwise don`t save, or will erase the data.
    ...
    try:
        #judge if KT58
        isKT58 = False
        if int(sn[-4:]) >= 211 or int(sn[-4:]) == 195 or int(sn[-4:]) == 196:
            print('Device of KT58, need to change the value of page 7,8,9 before write to eeprom...')
            isKT58=True
        #Firstly get vbias and vpi from the dataframe result
        vbias=[]
        vpi_all=[]
        ...
        if serial.Serial.isOpen(obj.CtrlB):
            ...
            if not isKT58:
                ...
                if flag=='IDT':
                    obj.CtrlB.write(b'fs400_set_eep_dev_drv1 0 0x0 0x01 0x0 0x480048 0x480048\n\r');time.sleep(0.2)
                    obj.CtrlB.write(b'fs400_set_eep_dev_drv2 0 0x0601 0xac 0x0e44 0x7771 0x3727\n\r');time.sleep(0.2)
                    obj.CtrlB.write(b'fs400_set_eep_dev_drv3 0 0x5111 0x01 0x1f40 '+(Drv3).encode('utf-8')+b'\n\r');time.sleep(0.2)
                    obj.CtrlB.write(b'fs400_set_eep_dev_tia1 0 0x03 0x000a 0xaf88\n\r');time.sleep(0.2)
                    obj.CtrlB.write(b'fs400_set_eep_dev_tia2 0 0x60 0xffff 0x04 2500\n\r');time.sleep(0.2)
                elif flag=='ALU':
                    obj.CtrlB.write(b'fs400_set_eep_dev_drv1 0 0x0 0x0 0 0x7d007d0 0x7d007d0\n\r');time.sleep(0.2)
                    obj.CtrlB.write(b'fs400_set_eep_dev_drv2 0 0xffff 0xff 0xffff 0xffff 0xffff\n\r');time.sleep(0.2)
                    obj.CtrlB.write(b'fs400_set_eep_dev_drv3 0 0xffff 0x01 0x1f40 0x12fc\n\r');time.sleep(0.2)
            ...
            if not isKT58:
                ...
                if flag == 'IDT':
                    ...
                    obj.CtrlB.write(b'fs400_set_eep_dev_drv2 1 0x0601 0xac 0x0e44 0x7771 0x3727\n\r');
                    time.sleep(0.2)
                    obj.CtrlB.write(b'fs400_set_eep_dev_drv3 1 0x5111 0x01 0x1f40 ' + (Drv3).encode('utf-8') + b'\n\r');
                    time.sleep(0.2)
                    obj.CtrlB.write(b'fs400_set_eep_dev_tia1 1 0x03 0x000a 0xaf88\n\r');
                    time.sleep(0.2)
                    obj.CtrlB.write(b'fs400_set_eep_dev_tia2 1 0x60 0xffff 0x18 2500\n\r');
            ...
            if not isKT58:
                ...
                if flag == 'IDT':
                    ...
                    obj.CtrlB.write(b'fs400_set_eep_dev_drv2 2 0x0601 0xac 0x0e44 0x7771 0x3727\n\r');
                    time.sleep(0.2)
                    obj.CtrlB.write(b'fs400_set_eep_dev_drv3 2 0x5111 0x01 0x1f40 ' + (Drv3).encode('utf-8') + b'\n\r');
                    time.sleep(0.2)
                    obj.CtrlB.write(b'fs400_set_eep_dev_tia1 2 0x03 0x000a 0xaf88\n\r');
                    time.sleep(0.2)
                    obj.CtrlB.write(b'fs400_set_eep_dev_tia2 2 0x60 0xffff 0x08 2500\n\r');
...
def write_eeprom_final_withAnalyze(obj,sn,df,dut_level,flag='IDT',Drv3='0x12fc',tempe=4310,VOA_cal=25):
    '''
    Write the test data into the eeprom with all the pages:0-5,7,8,9,11-16
    Update on 20220908:Write all the pages including all VOA calibration data, and add read and check,
    Attention:Always write all we need before save, otherwise don`t save, or will erase the data.
    :param obj,df: to get vbias:[1,2,3,4,5,6] list,vpi:float
    :param level:device level to determine what to write in to EEPROM
    :return: NA
    '''
    try:
        #Need to check whether Res data is ready in DC test thread and pass the judgement here
        if dut_level=='1':
            cmd_page=''
        elif dut_level=='2':
            cmd_page=''
...
def write_eeprom_final_pageSeperateKT58(obj,page,sn,df,dut_level,flag='IDT',Drv3='0x12fc',tempe=4310,VOA_cal=25):
    '''
        ...
        if serial.Serial.isOpen(obj.CtrlB):
            if int(page)==0:
                ...
                if flag=='IDT':
                    ...
                    print('PKD information write:\n\r', m2)
                    obj.CtrlB.write(m2);
                    time.sleep(0.2)  # b'fs400_set_eep_drv_pdk 0x1122 0x1122 0x1122 0x1122\n'
                    # obj.CtrlB.write(b'fs400_set_eep_tia_pdk 0 0 0 0\n\r');
                    # time.sleep(0.2)
                else:
                    obj.CtrlB.write(b'fs400_set_eep_drv_pdk 0 0 0 0\n\r');time.sleep(0.2)
                ...
                if not isKT58:
                    if flag == 'IDT':
                        ...
                        time.sleep(0.2)
                        obj.CtrlB.write(
                            b'fs400_set_eep_dev_drv3 0 0x5111 0x01 0x1770 ' + (Drv3).encode('utf-8') + b'\n\r');
                        time.sleep(0.2)
                        obj.CtrlB.write(b'fs400_set_eep_dev_tia1 0 0x03 0x000a 0xaf88\n\r');
                        time.sleep(0.2)
                        obj.CtrlB.write(b'fs400_set_eep_dev_tia2 0 0x60 0xffff 0x18 2500\n\r');
                    ...
                    if flag == 'IDT':
                        ...
                        time.sleep(0.2)
                        obj.CtrlB.write(
                            b'fs400_set_eep_dev_drv3 0 0x5111 0x01 0x1f40 ' + (Drv3).encode('utf-8') + b'\n\r');
                        time.sleep(0.2)
                        obj.CtrlB.write(b'fs400_set_eep_dev_tia1 0 0x03 0x000a 0xaf88\n\r');
                        time.sleep(0.2)
                        obj.CtrlB.write(b'fs400_set_eep_dev_tia2 0 0x60 0xffff 0x04 2500\n\r');
                ...
                if not isKT58:
                    if flag == 'IDT':
                        ...
                        time.sleep(0.2)
                        obj.CtrlB.write(
                            b'fs400_set_eep_dev_drv3 1 0x5111 0x01 0x1770 ' + (Drv3).encode('utf-8') + b'\n\r');
                        time.sleep(0.2)
                        obj.CtrlB.write(b'fs400_set_eep_dev_tia1 1 0x03 0x000a 0xaf88\n\r');
                        time.sleep(0.2)
                        obj.CtrlB.write(b'fs400_set_eep_dev_tia2 1 0x60 0xffff 0x18 2500\n\r');
                    ...
                    if flag == 'IDT':
                        ...
                        time.sleep(0.2)
                        obj.CtrlB.write(
                            b'fs400_set_eep_dev_drv3 1 0x5111 0x01 0x1f40 ' + (Drv3).encode('utf-8') + b'\n\r');
                        time.sleep(0.2)
                        obj.CtrlB.write(b'fs400_set_eep_dev_tia1 1 0x03 0x000a 0xaf88\n\r');
                        time.sleep(0.2)
                        obj.CtrlB.write(b'fs400_set_eep_dev_tia2 1 0x60 0xffff 0x18 2500\n\r');
                ...
                if not isKT58:
                    if flag == 'IDT':
                        ...
                        time.sleep(0.2)
                        obj.CtrlB.write(
                            b'fs400_set_eep_dev_drv3 2 0x5111 0x01 0x1770 ' + (Drv3).encode('utf-8') + b'\n\r');
                        time.sleep(0.2)
                        obj.CtrlB.write(b'fs400_set_eep_dev_tia1 2 0x03 0x000a 0xaf88\n\r');
                        time.sleep(0.2)
                        obj.CtrlB.write(b'fs400_set_eep_dev_tia2 2 0x60 0xffff 0x08 2500\n\r');
                    ...
                    if flag == 'IDT':
                        ...
                        time.sleep(0.2)
                        obj.CtrlB.write(
                            b'fs400_set_eep_dev_drv3 2 0x5111 0x01 0x1f40 ' + (Drv3).encode('utf-8') + b'\n\r');
                        time.sleep(0.2)
                        obj.CtrlB.write(b'fs400_set_eep_dev_tia1 2 0x03 0x000a 0xaf88\n\r');
                        time.sleep(0.2)
                        obj.CtrlB.write(b'fs400_set_eep_dev_tia2 2 0x60 0xffff 0x08 2500\n\r');
    ...
    try:
        ...
        if serial.Serial.isOpen(obj.CtrlB):
            ...
            return (mark_flag,ver,sn,headLength,drv_type,drv_ver1,drv_ver2,drv_ver3,
                ...
                if info[0]!='FS' or int(info[1])!=3 or info[2]!=sn or drv_t!=info[4] or info[5][2:]!=c1 or \
                    info[6][2:]!=c2 or info[7][2:]!=c3 or info[9][2:]!=a1 or info[10][2:]!=a2 or info[11][2:]!=a3 \
                        or c2=='0xffff' or c3=='0xffff' or a2=='0xffff' or a3=='0xffff' \
                        or int(c2,16)==0 or int(c3,16)==0 or int(a2,16)==0 or int(a3,16)==0:
                    return False
                else:
                    return True
            ...
            return (mark_flag,ver,sn,headLength,drv_type,drv_ver1,drv_ver2,drv_ver3,
                ...
                if info[0] != 'FS' or int(info[1]) != 3 or info[2] != sn or drv_t != info[4] or info[5][2:] != c1 or \
                        info[6][2:] != c2 or info[7][2:] != c3 or info[9][2:] != a1 or info[10][2:] != a2 or info[11][
                                                                                                             2:] != a3 \
                        or c2 == '0xffff' or c3 == '0xffff' or a2 == '0xffff' or a3 == '0xffff' \
                        or int(c2, 16) == 0 or int(c3, 16) == 0 or int(a2, 16) == 0 or int(a3, 16) == 0:
                    return False
...
def TIA_config_EepTIA(obj):
    ...
    if serial.Serial.isOpen(obj.CtrlB):
        ...
        #输出开启
        if not TIA_write(obj,'000c','0000'):return
        #Only for TIA PKD reading
        if not TIA_write(obj, '0016', '0e44'): return
        #DAC开启，PD上电
        obj.CtrlB.write(b'switch_set 10 0\n')
        time.sleep(0.1)
        obj.CtrlB.write(b'cpld_spi_wr 0x2c 2150\n')
        ...
        # write to EEPROM
        # pkd read
        obj.CtrlB.write(b'fs400_tia_read 0x002f\n\r');
        time.sleep(0.5)
        if not b'fs400_tia_read' in obj.CtrlB.read_all():
            print(obj.CtrlB.read_all())
        obj.CtrlB.write(b'fs400_tia_read 0x002f\n\r');
        time.sleep(0.5)
        s = obj.CtrlB.read_all().decode('utf-8').split(' ')
        ...
        while b1 == '0000' or b1 == 'ffff':
            ...
            count += 1
            if count == 5:
                print('5 times not get TIA pdk1 value, please check')
                break
        obj.CtrlB.write(b'fs400_tia_read 0x012f\n\r');
        time.sleep(0.5)
        print(obj.CtrlB.read_all())
        obj.CtrlB.write(b'fs400_tia_read 0x012f\n\r');
        time.sleep(0.5)
        ...
        while b2 == '0000' or b2 == 'ffff':
            ...
            count += 1
            if count == 5:
                print('5 times not get TIA pdk2 value, please check')
                break
        obj.CtrlB.write(b'fs400_tia_read 0x022f\n\r');
        time.sleep(0.5)
        print(obj.CtrlB.read_all())
        obj.CtrlB.write(b'fs400_tia_read 0x022f\n\r');
        time.sleep(0.5)
        ...
        while b3 == '0000' or b3 == 'ffff':
            ...
            count += 1
            if count == 5:
                print('5 times not get TIA pdk3 value, please check')
                break
        obj.CtrlB.write(b'fs400_tia_read 0x032f\n\r');
        time.sleep(0.5)
        print(obj.CtrlB.read_all())
        obj.CtrlB.write(b'fs400_tia_read 0x032f\n\r');
        time.sleep(0.5)
        ...
        while b4 == '0000' or b4 == 'ffff':
            ...
            count += 1
            if count == 5:
                print('5 times not get TIA pdk4 value, please check')
                break
        m2 = 'fs400_set_eep_tia_pdk 0x{} 0x{} 0x{} 0x{}\n\r'.format(b1, b2, b3, b4).encode('utf-8')
        print('TIA PKD information write:\n\r', m2)
        obj.CtrlB.write(m2)
        time.sleep(0.2)  # b'fs400_set_eep_drv_pdk 0x1122 0x1122 0x1122 0x1122\n'
        print(obj.CtrlB.read_all())
