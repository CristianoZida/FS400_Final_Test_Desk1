...
path=r'R:\Normal\WRRC290080\DC\20220919_142325'
f1=os.path.join(path,'WRRC290080_DC_20220919_142325.csv')
df1=pd.read_csv(f1)
print(df1)
device_type='IDT'
if device_type=='ALU':
...
gf.write_eeprom_final(mawin,sn,df1,device_type,'0x13b5',4080)
